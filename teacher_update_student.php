...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    $marks = $_POST['marks'];
        ...
        //saved to  database
        $query="UPDATE student SET student_name='$student_name', class='$class', email_id='$email_id', phone_no='$phone_no' ,marks='$marks' WHERE email_id='$email_id_old' ";
    ...
    <div class="form">
        <form method="post">
            ...
            <div class="container">
                ...
                <div><input type="" placeholder="Marks"  value="<?php echo "$marks_old" ?>"   style="width: 100%;" name="marks"></div>
            </div>
