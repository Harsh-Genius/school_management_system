...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    if(!empty($student_name) && !empty($class) && !empty($email_id) && !empty($phone_no) )  //&& !is_numeric($user_name)
    {
        
        //saved to  database
        $query="insert into student (student_name,class,email_id,phone_no) values ('$student_name','$class','$email_id','$phone_no')";
    ...
    <div class="form">
        <form method="post">
            ...
            <div class="container">
                ...
                <div><input type="text" placeholder="Harsh" style="width: 100%;" name="student_name"></div>
            </div>
            <div class="container">
