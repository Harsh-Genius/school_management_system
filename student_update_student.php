...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    $password =$_POST['password'];
        ...
        //saved to  database
        $query="UPDATE student SET phone_no='$phone_no',student_password='$password' WHERE email_id='$email_id_old' ";
    ...
    <div class="form">
        <form method="post">
            ...
            <div class="container">
                ...
                <div><center><label><?php echo "$student_name_old" ?></lable><center></div>
            </div>
            <div class="container">
